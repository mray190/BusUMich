 ...
 */
public class Bus {
    private int id, name, heading, route, lastStop, lastTime;
    private double lat, lon;

    public Bus(int id, int name, int heading, int route, int lastStop, int lastTime, double lat, double lon) {
        this.id = id;
        this.lat = lat;
        this.lon = lon;
        this.name = name;
    ...
    public void setLastTime(int lastLastTime) { this.lastTime = lastTime; }
}